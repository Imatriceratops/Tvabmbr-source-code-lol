...
class WeekEditorState extends MusicBeatState implements PsychUIEventHandler.PsychUIEvent
{
	...
	override function create() {
		...
		txtWeekTitle.setFormat(Paths.font("andybold.OTF"), 32, FlxColor.WHITE, RIGHT);
		...
		missingFileText.setFormat(Paths.font("andybold.OTF"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		txtTracklist.font = Paths.font("andybold.OTF");
