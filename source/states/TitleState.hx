...
import states.SillyWarningState;
typedef TitleData =
{
	var titlex:Float;
	var titley:Float;
...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		if(FlxG.save.data.flashing == null && !SillyWarningState.leftState)
		{
	...
	function startIntro()
	{
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('HaxeflixelnTvabmb'));
		ngSpr.visible = false;
	...
	override function beatHit()
	{
		...
		if(!closedState)
		{
			...
			switch (sickBeats)
			{
				...
				case 2:
					createCoolText(['This mod has been', 'brought to you by'], 15);

					addMoreText('The Cool Bday Team!!', 40);
				case 3:
					deleteCoolText();
				case 4:
					createCoolText(['Starjai/SMD2', 'ProdByProto', 'Creitin Gameplays'], 40);
					
					addMoreText('And More!', 40);
				case 5:
					deleteCoolText();
				case 6:
					createCoolText(['Not messing', 'with'], -40);
				case 8:
					addMoreText('Haxeflixel and Tvabmb', -40);
					ngSpr.visible = true;
				case 9:
					deleteCoolText();
					ngSpr.visible = false;
			    case 10: createCoolText(['Haii Conny! Hai Snowy!'], 40);
				case 11:
				...
				case 14:
					deleteCoolText();
			    case 15: createCoolText(['Welcome to', 'the'], 15);
				case 16:
					deleteCoolText();
				case 17:
					createCoolText(['Cool'], 40);
				case 18:
					addMoreText('Mod', 40);
				case 19:
					addMoreText('Bundle', 40);
				case 20:
					addMoreText('Restored', 40); // credTextShit.text += '\nFunkin';
