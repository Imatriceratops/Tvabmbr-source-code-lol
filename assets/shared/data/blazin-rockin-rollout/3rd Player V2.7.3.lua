characterPath = 'characters/Starjai' -- Picture File name of spreadsheet (must have .xml)
characterTag = 'starjai' -- Set this to what the sprite should be named.
...
singAnimationLength = 6.1 -- How many steps until it goes back to idle.
...
--]]
animationData = {
    ['idle'] = {'Idle', -362, -237, '', false},
    ['idle-alt'] = {'BF idle dance', -5, 0, '', false},

    ['singLEFT'] = {'left0', -367, -238, '', false},
    ['singDOWN'] = {'down0', -362, -273, '', false},
    ['singUP'] = {'up alt0', -362, -249, '', false},
    ['singRIGHT'] = {'right0', -356, -239, '', false},
...
characterCamera = {
    -410, -- X (Offset) for the camera to be targetting when it is extra character's turn.
    240 -- Y (Offset) for the camera to be targetting when it is extra character's turn.
}
